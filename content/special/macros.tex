...
\newenvironment{SixSessionOverview}[8]{
  ...
  \begin{center}
    \righthyphenmin2
    \sloppy
    \begin{tabular}{|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|}
      \hline
      \bf Track A & \bf Track B & \bf Track C & \bf Track D & \bf Track E & \bf Track F \\\hline
      \it #3 & \it #4 & \it #5 & \it #6 & \it #7 & \it #8 \\
      \hline\hline}
{\hline\end{tabular}\end{center}}

\newenvironment{SixSessionsmall}[8]{
  \begin{center}
    \righthyphenmin2
    \sloppy
    \begin{tabular}{|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|>{\RaggedRight}p{0.65in}|}
